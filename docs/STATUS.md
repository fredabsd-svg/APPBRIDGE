...
> tarefa (**T-201**) concluída, com testes. **T-202 também concluída na mesma sessão** — EF Core +
> PostgreSQL + primeira migração, aplicada e revertida contra banco real, 8 testes automatizados. Ver
...
| **—** | **Fundação do Control Plane — ✅ T-201 e T-202 concluídas (S010); T-203 em diante seguem em paralelo com E-01** | E-02 | Precisa só de Postgres de dev, já instalado nesta sessão |
