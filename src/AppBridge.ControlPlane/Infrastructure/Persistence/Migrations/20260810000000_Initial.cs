        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: new[] { table.Column<Guid>(type: "uuid", nullable: false), table.Column<Guid>(type: "uuid", nullable: false) },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    logged_at = table.Column<DateTime>(type: "timestamptz", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_applications_tenant_id_identifier",
                table: "applications",
                columns: new[] { "tenant_id", "identifier" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_application_user_permissions_tenant_id_application_id_user_id",
                table: "application_user_permissions",
                columns: new[] { "tenant_id", "application_id", "user_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_tenant_id_category_occurred_at",
                table: "audit_logs",
                columns: new[] { "tenant_id", "category", "occurred_at" },
                descending: new bool[] { false, false, true });

            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_tenant_id_resource_type_resource_id_occurred_at",
                table: "audit_logs",
                columns: new[] { "tenant_id", "resource_type", "resource_id", "occurred_at" },
                descending: new bool[] { false, false, false, true });

            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_tenant_id_result_occurred_at",
                table: "audit_logs",
                columns: new[] { "tenant_id", "result", "occurred_at" },
                descending: new bool[] { false, false, true });

            migrationBuilder.CreateIndex(
                name: "IX_sessions_tenant_id_state_created_at",
                table: "sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_users_tenant_id_identifier",
                table: "users",
                columns: new[] { "tenant_id", "identifier" },
                unique: true);
        }
